...
let i = 1; // this is for id names for each order, refer to line 123
function formHandler() {
    ...
    form.addEventListener("submit", e => {
        ...
        i++; // each time form is sent, 1 will be added to i, thus will be inserted to the next order detail when the next order is placed
        form.reset(); // each time form is sent, the form will be reset so the next customer can customize their pizza from scratch
    });
